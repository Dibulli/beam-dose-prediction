...
class UNet(nn.Module):
    def __init__(self, n_channels, n_classes, init_weights=True):
        ...
        self.dres0 = ResConv(32, 64)
        self.dres1 = ResConv(64, 128)
        self.dres2 = ResConv(128, 256)
        self.dres3 = ResConv(256, 512)
        self.dres4 = ResConv(512, 1024)
        self.dres5 = ResConv(1024, 2048)
        self.dres6 = ResConv(2048, 4096)

        self.ures0 = ResConv(64, 32)
        self.ures1 = ResConv(128, 64)
        self.ures2 = ResConv(256, 128)
        self.ures3 = ResConv(512, 256)
        self.ures4 = ResConv(1024, 512)
        self.ures5 = ResConv(2048, 1024)

        self.up5 = Up(4096, 2048)
        self.up4 = Up(1024, 1024)
        self.up3 = Up(512, 512)
        self.up2 = Up(256, 256)
        self.up1 = Up(128, 128)
        self.up0 = Up(64, 64)
